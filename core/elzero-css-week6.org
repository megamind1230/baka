...
| - =background-image: linear-gradient(to right , red, green);= - 2 or more colors - can change =alpha channel= - second color {green} =to right= - btw: can go diagonally =to bottom right= - =to top= = =0deg= - =to right= = =90deg= - =to bottom= = =180deg= - =to left= = =270deg= |
| ```                                                                                                                                                                                                                                                                                   |
...
| - [[https://youtu.be/wYSAjaB3mL8?si=qAwQPMqkFAPqldYf&t=549][fraction vs auto]] - =auto= is shy .. just takes what is enough for its content - =fr= is greedy                                                                                                                          |
| ​# 58                                                                                                                                                                                                                                                                                  |
...
| - remember that =justify-content & align-content & align-items= work only when there is some extra space in parent - so better use them with =auto= not =fr= .. cuz =fr= takes remaining space whatever the case                                                                      |

* 60

#+begin_quote
[[https://www.youtube.com/watch?v=q6VtSllQHHo][Learn CSS In Arabic 2021 - #60 - Grid - Parent - Complete Layout With Template Areas]]
#+end_quote
...
[[file:css-viewport-units.org][100vh]] #still/css/viewport_units
[[file:elzero-css-week4.org][box-sizing]]
...
# 63
advanced
>[[https://www.youtube.com/watch?v=NO4IeLSKNdw][Learn CSS In Arabic 2021 - #63 - Grid - Min, Max And Auto Fill]]
...
[[file:elzero-css-grid-read-about-auto-fit-and-ch.org][elzero-css-grid-read-about-auto-fit-and-ch]]
# 64
>[[https://cssgridgarden.com/][Learn CSS In Arabic 2021 - #64 - Finish The Grid Garden Game]]
