...
# [[file:0-great-projects-to-do-now.org][0-great-projects-to-do-now]]
#+end_quote
...
- [ ] [[file:my-wiki-channels-project.org][my-wiki-channels-project]]

- idea يعم جاريني بس .. اسم بلايلست يوتيوب

- بحب اطلع اصوات جديدة ziad zaza

- [[file:0-playlist-names-for-my-channel.org][0-playlist-names-for-my-channel]]
...
- [[file:reddit-spaces-name-ideas.org][reddit-spaces-name-ideas]]
...
- [[file:the-comment-section-reaction-series.org][the-comment-section-reaction-series]]
...
- radio phone calls app
  > [[https://nevonprojects.com/project-ideas/software-project-ideas/][ref]]
...
- [[file:my-serious-talk-app.org][my-serious-talk-app]]

- [[file:0-my-grad-proj-ideas.org][0-my-grad-proj-ideas]]

- [[file:grad-proj-names-new.org][grad-proj-names-new]]

- [[file:@-grad-proj-team-meetings-MOC.org][@-grad-proj-team-meetings-moc]]
...
- Follow me bot..
  ...
  - but suddenly I found this [[https://www.jitbit.com/macro-recorder/macro-recorder-video-tutorial/][macro recorder]]

- Make a website to host images of mind maps / recaps .. u pay uploaders from the ad profit [[file:0-ideas.org][can relate to mine here]]
