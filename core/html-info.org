* HTML Tags
[[file:html-non-closing-tags-OR-empty-elements.org][html-non-closing-tags-OR-empty-elements]] meta
charset .. defines the encoding type.. is important in old machines
[[file:../attachments/Pasted-image-20231028184305.png]]
# HTML Heading - normal text is larger than =<h4>= - and .. normal is not bold - heading has it's own line .. no other text on that line are shown - in =<p>= multi spaces and returns ignored
# HTML Paragraph
[[file:html-non-closing-tags-OR-empty-elements.org][html-non-closing-tags-OR-empty-elements]] =<br>= line break
=&nbsp;= for additional spaces in =<p>= .. non breaking space
[[file:html-non-closing-tags-OR-empty-elements.org][html-non-closing-tags-OR-empty-elements]] =<hr>= horizontal rule separator (block element)
[[file:html-non-closing-tags-OR-empty-elements.org][html-non-closing-tags-OR-empty-elements]] comment
...
* HTML Pictures
[[file:html-non-closing-tags-OR-empty-elements.org][html-non-closing-tags-OR-empty-elements]]
...
[[https://www.w3schools.com/html/html_blocks.asp][HTML Block and Inline Elements]]
...
* HTML Video
[[file:html-non-closing-tags-OR-empty-elements.org][html-non-closing-tags-OR-empty-elements]] source
...
[[https://www.w3schools.com/html/tryit.asp?filename=tryhtml_iframe_target][showcase]]
# HTML Semantics
semantic elements in html - div is non semantic - so we use the semantic tags .. same as div .. but intuitive - [[file:../attachments/Pasted-image-20231030105214.png]]
...
- Gammal=426625
  - [[file:../attachments/Pasted-image-20231031092854.png]]
