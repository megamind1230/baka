- [X] [[https://www.geeksforgeeks.org/difference-between-abstract-class-and-interface-in-c-sharp/][Difference between Abstract Class and Interface in C# | GeeksforGeeks]]

|                   | abstract class                              | interface               |
|-------------------+---------------------------------------------+-------------------------|
| multi inheritance | some languages dont support itlike c#, java | supported               |
