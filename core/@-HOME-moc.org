[[file:todo.org][todo]] , [[https://drive.google.com/drive/folders/1axtwf4X1hXZrA1S52po6SWfJVf2z_s0l?usp=sharing][grad projects]]
[[file:home-extension.org][home-extension]]
...
- [X] النظم المدمجة
- [ ] موضوعات مختارة 1
- [[file:../Pasted image 20251022184608.png]]
...
https://youtube.com/[cite/t:@emacselements?si]=GStOVMDys4p_fTOn
emacs
...
” open command-line window (edit history!)
...
- great linux docs
  ...
  - [ ] the gnu manuals
  - [ ] personal blogs
- [[file:cool-articles.org][cool-articles]]
  [[https://stackoverflow.com/questions/8450863/creating-a-c-sharp-application-without-sql-server][Creating a C# application without SQL Server - Stack Overflow]]
...
netrw - back - vim-dadbod DB plugin for nvim
...
curiousmind0808
rvappstudios
[cite/t:@officialalphablocks]
[cite/t:@ABCmouse]
[cite/t:@caillou]
[cite/t:@artforkidshub]
[cite/t:@LittleSports]
[cite/t:@natgeokids]
[cite/t:@HomeschoolPop]
[cite/t:@Madrasetnabreaktime]
...
`=bash man -k . | dmenu -l 20 | awk '{printf $1}' | xargs -r man -Tpdf | zathura - *=sicp: Structure and Interpretation of Computer Programs` a huge intro to emacs lisp with exercises
...
https://medium.com/[cite/t:@thegregjames/10-advanced-useful-shell-script-commands-1fd52980f4df]
...
https://hackmd.io/[cite/t:@5gkOktjvQi2isL_Ebd7tIg/SyrhaxRaI]
...
swift jobs eg
https://www.tiktok.com/[cite/t:@techwruby/video/7275392803629255942]
...
ctrl alt left ? vscode split - [ ] mermaid live editor online - [ ] time blocking in obsidian? - [ ] full calendar in obsidian? - [ ] i know how to drag and drop from host into vm.. but the opposite?

- [ ] shared folder vm
  - [[https://www.youtube.com/watch?v=2KczxDvTuAE][Virt Manager | مشاركة الملفات بين لينكس وويندوز الافتراضي - YouTube]]
  - [[https://www.youtube.com/watch?v=DjEbeW0Px2g][Share Files Between your Linux Host and VMs with virtiofs | KVM - YouTube]]
  - [[https://www.youtube.com/results?search_query=virtiofs+is+not+yet+supported][virtiofs is not yet supported - YouTube]]
...
[[file:bitwarden-how-to-use-it.org][bitwarden-how-to-use-it]]
