...
[[file:0-markdown-in-discord.org]]
# [[https://www.guidingtech.com/discord-keyboard-shortcuts/][37 Best Discord Keyboard Shortcuts You Must Know - Guiding Tech]]
#+end_quote
...
- =ctrl alt up/down= > navigate servers ={pane 1}=
  - [[file:0-disable-ctrl-alt-arrow-weird-interaction-in-windows-10.org]]
...
- =ctrl shift t= > create private group
  ​# tricks
- [X] [[https://www.youtube.com/watch?v=ZhxmZdETQ2s&ab_channel=HowtoKylr][How to Make Reaction Roles on Discord 2022 - YouTube]]
