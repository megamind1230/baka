* hill cipher
[[file:../attachments/Pasted image 20250613152920.png]]
[[file:../attachments/Pasted image 20250612162605.png]]
...
Given Information: - Plaintext: "Secrecy" (we'll use only "Sec") - Key matrix K:
=[21  5 11]   [14  7 12]   [ 5 25 12]=
...
* s-box
[[file:../attachments/Pasted image 20250612162812.png]]
...
The 6-bit input is interpreted as: - *First and last bits (bits 1 and 6)* form a 2-bit row number (0-3) - *Middle 4 bits (bits 2-5)* form a 4-bit column number (0-15)

#+begin_example
 Step 2: Break Down the Input
#+end_example

Input: =1 0111 1= (spaces added for clarity) - First bit (b1): =1= - Middle 4 bits (b2-b5): =0111= - Last bit (b6): =1=
...
* playfair
[[file:../attachments/Pasted image 20250612164330.png]]

Playfair Cipher Encryption

I'll explain how to encrypt the plaintext "cryptography" using the Playfair cipher with the key "security".

Given Information: - *Plaintext*: "cryptography" (prepared as "cr yp to gr ap hy") - *Key*: "security" - *Expected Ciphertext*: "US BN AM KC BO GA"
...
Plaintext: "cryptography" - Split into digrams (pairs of 2 letters): - cr yp to gr ap hy - No double letters or odd-length adjustments needed here
...
- 'h' at Row 2, Column 3
- 'y' at Row 1, Column 2
- Different row and column: Form rectangle - Rectangle corners: 'h', 'y', 'k', 'a' - 'h' → 'g' - 'y' → 'a'
  - Ciphertext: "ga"
...
* RSA
[[file:../attachments/Pasted image 20250613153640.png]]
