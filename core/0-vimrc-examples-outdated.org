- [X] [[https://github.com/abdalrahmanshaban0/Vim-for-CP][GitHub - abdalrahmanshaban0/Vim-for-CP: My vim configuration to write and run C/C++ code for competitive programming or any thing similar.]]
