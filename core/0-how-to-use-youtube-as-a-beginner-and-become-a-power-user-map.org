...
- UI
  - normal video page
    ...
    - three ways to share a video at a specific timestamp
      ...
      - third: just type it in the link bar and copy it
        - [[https://www.lifewire.com/link-to-specific-part-of-youtube-video-1616414#:~:text=Easiest%3A%20Open%20the%20YouTube%20video,%2C%20use%20%3Ft%3D%20instead.][How to Link to a Specific Part in a YouTube Video]]
    - creators channel
  ...
  - shorts page
    ...
    - navigation sometimes is trash in the pc version .. so you sometimes need to install an extension
      - [[https://chromewebstore.google.com/detail/controls-for-youtube-shor/daocpklojfnjgomjaemhhibodkpcjlpe][Controls for YouTube™ Shorts]]
...
- websites
  - [[https://en.savefrom.net/391GA/][Free Online Video Downloader - SaveFrom.net]]
- apps
  - on windows
    - idk .. search it
  - on linux
    - [[https://flathub.org/apps/com.github.unrud.VideoDownloader][Install Video Downloader on Linux | Flathub]]
    - [[https://flathub.org/apps/io.github.aandrew_me.ytdn][Install Youtube Downloader Plus on Linux | Flathub]]
- from within telegram
  - [cite/t:@YouTube_Downland_mp4_bot]
...
- vimium
  ...
  - shortcuts
    - [[file:0-Vimium-extension-for-browsers.org]]
