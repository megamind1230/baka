- [x] [[vscode-issues-moc|issues I saw along the way]]
- [x] [nvim kongfu article here](https://www.barbarianmeetscoding.com/boost-your-coding-fu-with-vscode-and-vim/table-of-contents)
- copy my VSCodeVim json file [[0-vscodevim-json-file|here]]
