...
# wants and needs - [x] best plugin manager for neovim - [x] lazy.nvim is the best plugin manager - [x] meanwhile lazy.vim is a vim distro - [ ] autopair brackets - [ ] command to compile current file - [ ] cpp - [ ] cpp syntax highlighting - [ ] cpp code completion - [ ] cpp code snippet - [ ] view files {nerdtree?} - [ ] fzf or telescope
# no plugins + work
