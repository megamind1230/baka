...
[[file:elzero-css-week8.org][more]]
# pseudo-elements
## 35
...
=::before= [[https://youtu.be/OIWZ4EXwlnA?si=mVfdk4w1CJF24mbf&t=372][some alignment math tricks]] + [[https://youtu.be/OIWZ4EXwlnA?si=Jq-CvktMvhHprvor&t=432][how to make a simple arrow in css]]
...
[[https://youtu.be/4WT2eO8aM7U?si=B4Cwu5FGTjL3FhxV&t=394][how to make the simple arrow before the list items]] =li= .. notice that =position: relative;= for =li=
...
website to help [[https://caniuse.com/][Can I use... Support tables for HTML5, CSS3, etc]]
...
[[https://www.youtube.com/watch?v=9PDCOviQOwo&list=PLDoPjvoNmBAzjsz06gkzlSrlev53MGIKe&index=41][Learn CSS In Arabic 2021 - #41 - The Box Model And Box Sizing - YouTube]]

=box-sizing: content-box=\\
{default} makes width & height of box = content + padding + margin + border

=box-sizing: border-box= better use it with eg: [[file:elzero-css-week6.org][grid]]
makes width & height of box are just as you define them .. the numbers you set to them are respected

[[https://youtu.be/9PDCOviQOwo?si=2OFPmZ-xn0BACiRZ&t=379][wildcard]]
