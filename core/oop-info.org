...
better for mem & algo ds to define methods outside - static method of a class - wrong [[file:../attachments/Pasted-image-20231013192302.png]] - correct [[file:../attachments/Pasted-image-20231013192331.png]]

* Protected
[[file:../attachments/Pasted-image-20231013195757.png]]
...
[[file:../attachments/Pasted-image-20231013195022.png]]

* Encapsulation
setters ( impl) , getters (interface)
[[file:../attachments/Pasted-image-20231014193637.png]]
[[file:../attachments/Pasted-image-20231014191951.png]]

* Multiple Inheritance
[[file:../attachments/Pasted-image-20231017102940.png]]

* More about Inheritance
- [[file:../attachments/Pasted-image-20231021101507.png]]
...
[[file:0-func-overloading-overriding-overwrite.org][0-func-overloading-overriding-overwrite]]

[[file:../attachments/Pasted-image-20231028134047.png]]
like the following
...
- [[file:../attachments/Pasted-image-20231021111750.png]]
  - 5
...
* Abstraction
[[file:../attachments/Pasted-image-20231021113639.png]]

* Abstract Class
[[file:../attachments/Pasted-image-20231028134830.png]]
[[file:../attachments/Pasted-image-20231028134844.png]] - [[file:../attachments/Pasted-image-20231021121439.png]] - 3 طالما الديرايف عمل لنفسه نسخة من فن - يبقى عادي ناخد منه اوبجكت - 4, 5 - لاحظ مفيش نسخة من فن في ال class A - لذلك مينفعش تاخد منه نسخة

* Default Arguments
- [[file:../attachments/Pasted-image-20231022182859.png]]
  - 5 .. in drv there is not fun .. that u can pass arguments to

* Friend Class
- [[file:../attachments/Pasted-image-20231022184742.png]]
  - 4 .. {data} is private in {Test}
  - 5 .. there is no {data} member in {other}
    [[file:../attachments/Pasted-image-20231028135722.png]]
    [[file:../attachments/Pasted-image-20231028135741.png]]
    ​# Polymorphism
...
[[file:../attachments/Pasted-image-20231022190306.png]]
